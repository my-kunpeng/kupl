...
#define KUPL_ATOMIC_CAS_BASE(op, p, ex, v, order1, order2) (p)->op(ex, v, std::memory_order_##order1,  \
                                                                           std::memory_order_##order2)
...
#define KUPL_ARCH_ATOMIC_CAS_STR(p, ex, v)                 KUPL_ATOMIC_CAS_BASE(compare_exchange_strong,  \
                                                                                  p, ex, v, seq_cst, seq_cst)
#define KUPL_ARCH_ATOMIC_CAS_STR_RLS2RLX(p, ex, v)         KUPL_ATOMIC_CAS_BASE(compare_exchange_strong,  \
                                                                                  p, ex, v, release, relaxed)
#define KUPL_ARCH_ATOMIC_CAS_STR_ACQ2RLX(p, ex, v)         KUPL_ATOMIC_CAS_BASE(compare_exchange_strong,  \
                                                                                  p, ex, v, acquire, relaxed)
#define KUPL_ARCH_ATOMIC_CAS_WEA(p, ex, v)                 KUPL_ATOMIC_CAS_BASE(compare_exchange_weak,    \
                                                                                  p, ex, v, seq_cst, seq_cst)
