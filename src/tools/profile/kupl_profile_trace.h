...
{
    switch (tag) {
        case KUPL_PTRACE_TASK_CREATE:
            return "TASK_CREATE";
        case KUPL_PTRACE_TASK_SUBMIT:
            return "TASK_SUBMIT";
        case KUPL_PTRACE_TASK_ENQUEUE:
            return "TASK_ENQUEUE";
        case KUPL_PTRACE_TASK_DEQUEUE:
            return "TASK_DEQUEUE";
        case KUPL_PTRACE_TASK_EXECUTE:
            return "TASK_EXECUTE";
        case KUPL_PTRACE_PERIOD_TASK_EXECUTE:
            return "PERIOD_TASK_EXECUTE";
        case KUPL_PTRACE_TASK_RESET:
            return "TASK_RESET";
        case KUPL_PTRACE_TASK_RELEASE:
            return "TASK_RELEASE";
        case KUPL_PTRACE_TASK_FINISH:
            return "TASK_FINISH";
        case KUPL_PTRACE_TASK_INIT:
            return "TASK_INIT";
        case KUPL_PTRACE_TASK_CLEANUP:
            return "TASK_CLEANUP";
        case KUPL_PTRACE_TASK_INVOKE:
            return "TASK_INVOKE";
        case KUPL_PTRACE_TASK_WAIT:
            return "TASK_WAIT";
        case KUPL_PTRACE_TASK_IN_LOOP:
            return "TASK_IN_LOOP";
        case KUPL_PTRACE_ULT_CREATE:
            return "ULT_CREATE";
        case KUPL_PTRACE_ULT_INIT:
            return "ULT_INIT";
        case KUPL_PTRACE_ULT_CLEANUP:
            return "ULT_CLEANUP";
        case KUPL_PTRACE_ULT_EXECUTE:
            return "ULT_EXECUTE";
        case KUPL_PTRACE_ULT_FINISH:
            return "ULT_FINISH";
        case KUPL_PTRACE_ULT_INVOKE:
            return "ULT_INVOKE";
        case KUPL_PTRACE_GLOBAL_EGROUP_GET:
            return "GLOBAL_EGROUP_GET";
        case KUPL_PTRACE_PARALLEL_FOR_GRAPH_GET:
            return "PARALLEL_FOR_GRAPH_GET";
        case KUPL_PTRACE_PARALLEL_FOR_CHECK:
            return "PARALLEL_FOR_CHECK";
        case KUPL_PTRACE_PARALLEL_FOR_NUM_THREADS:
            return "PARALLEL_FOR_NUM_THREADS";
        case KUPL_PTRACE_PARALLEL_FOR_POLICY_STATIC:
            return "PARALLEL_FOR_POLICY_STATIC";
        case KUPL_PTRACE_PARALLEL_FOR_POLICY_3D_STATIC:
            return "PARALLEL_FOR_POLICY_3D_STATIC";
        case KUPL_PTRACE_PARALLEL_FOR:
            return "PARALLEL_FOR";
        case KUPL_PTRACE_INVOKE_PARALLEL_FUNC:
