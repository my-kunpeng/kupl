...
namespace kupl {
    ...
    namespace tensor {
        ...
        public:
            ...
            friend void tensor_tiled_mma(TiledMma mma,
                                         Tensor<dtypeD, LayoutD> D,
                                         Tensor<dtypeA, LayoutA> A,
                                         Tensor<dtypeB, LayoutB> B,
                                         Tensor<dtypeC, LayoutC> C);
        private:
            template<typename dtypeD, typename LayoutD,
                     typename dtypeA, typename LayoutA,
                     typename dtypeB, typename LayoutB,
                     typename dtypeC, typename LayoutC>
            void call(Tensor<dtypeD, LayoutD> &D,
                      const Tensor<dtypeA, LayoutA> &A,
                      const Tensor<dtypeB, LayoutB> &B,
        ...
        public:
            ...
            friend void tensor_tiled_store(TiledStore store,
        ...
        public:
            ...
            friend void tensor_tiled_copy(TiledCopy copy,
                                          Tensor<dtypeD, LayoutD> dst,
                                          Tensor<dtypeS, LayoutS> src);
        ...
        private:
            template<typename dtypeD, typename LayoutD,
                     typename dtypeS, typename LayoutS>
            void call(Tensor<dtypeD, LayoutD> &dst,
                      const Tensor<dtypeS, LayoutS> &src) MMA_IN;
        ...
        template<typename TiledMma,
                 ...
                 typename dtypeB, typename LayoutB,
                 typename dtypeC, typename LayoutC>
        kupl_export void tensor_tiled_mma(TiledMma mma,
                                          Tensor<dtypeD, LayoutD> D,
                                          Tensor<dtypeA, LayoutA> A,
                                          Tensor<dtypeB, LayoutB> B,
        ...
        template<typename TiledStore, typename dtype, typename Layout>
        kupl_export void tensor_tiled_store(TiledStore store,
                                            Tensor<dtype, Layout> tensor) MMA_IN
        {
            store.call(tensor);
        }
        ...
        template<typename TiledCopy,
                 typename dtypeD, typename LayoutD,
                 typename dtypeS, typename LayoutS>
        kupl_export void tensor_tiled_copy(TiledCopy copy,
                                           Tensor<dtypeD, LayoutD> dst,
                                           Tensor<dtypeS, LayoutS> src) MMA_IN
        {
            copy.call(dst, src);
        }
        ...
        private:
            template<int size_m, int size_n, typename StrideA, typename StrideB, typename StrideC,
                     typename dtypeA, typename dtypeB, typename dtypeC>
        ...
        private:
            template<typename dtypeD, typename ShapeD, typename StrideD,
                     typename dtypeA, typename ShapeA, typename StrideA,
                     typename dtypeB, typename ShapeB, typename StrideB,
                     typename dtypeC, typename ShapeC, typename StrideC>
            void call([[maybe_unused]] Tensor<dtypeD, Layout<ShapeD, StrideD>> &D,
                      const Tensor<dtypeA, Layout<ShapeA, StrideA>> &A,
                      const Tensor<dtypeB, Layout<ShapeB, StrideB>> &B,
                      const Tensor<dtypeC, Layout<ShapeC, StrideC>> &C) MMA_INOUT
            {
                TiledCallFunc::call_mma<M_32 * AtomShapeM, N_16 * AtomShapeN,
                    StrideA, StrideB, StrideC, dtypeA, dtypeB, dtypeC>(
                    A.getPtr(), B.getPtr(), C.getPtr(), AtomShapeK * K_512);
            }
        };
        ...
        private:
                      ...
                      const Tensor<dtypeC, Layout<ShapeC, StrideC>> &C) MMA_INOUT
            {
                TiledCallFunc::call_mma<M_32 * AtomShapeM, N_16 * AtomShapeN,
                    StrideA, StrideB, StrideC, dtypeA, dtypeB, dtypeC>(
                    A.getPtr(), B.getPtr(), C.getPtr(), AtomShapeK);
            }
        };
        ...
        private:
            ...
            void call([[maybe_unused]] Tensor<dtypeD, Layout<ShapeD, StrideD>> &D,
                      ...
                      const Tensor<dtypeC, Layout<ShapeC, StrideC>> &C) MMA_INOUT
            {
                TiledCallFunc::call_mma<M_16 * AtomShapeM, N_64 * AtomShapeN,
                    StrideA, StrideB, StrideC, dtypeA, dtypeB, dtypeC>(
                    A.getPtr(), B.getPtr(), C.getPtr(), K_2 * AtomShapeK);
            }
        };
        ...
        private:
                      ...
                      const Tensor<dtypeC, Layout<ShapeC, StrideC>> &C) MMA_INOUT
            {
                TiledCallFunc::call_mma<M_16 * AtomShapeM, N_64 * AtomShapeN,
                    StrideA, StrideB, StrideC, dtypeA, dtypeB, dtypeC>(
                    A.getPtr(), B.getPtr(), C.getPtr(), K_4 * AtomShapeK);
            }
        };
        ...
        private:
            ...
            void call([[maybe_unused]] Tensor<dtypeD, Layout<ShapeD, StrideD>> &D,
                      ...
                      const Tensor<dtypeC, Layout<ShapeC, StrideC>> &C) MMA_INOUT
            {
                TiledCallFunc::call_mma<M_32 * AtomShapeM, N_32 * AtomShapeN,
                    StrideA, StrideB, StrideC, dtypeA, dtypeB, dtypeC>(
                    A.getPtr(), B.getPtr(), C.getPtr(), K_4 * AtomShapeK);
            }
        };
        ...
        private:
            template<typename dtypeD, typename ShapeD, typename StrideD,
                     typename dtypeS, typename ShapeS, typename StrideS>
            void call(Tensor<dtypeD, Layout<ShapeD, StrideD>> &dst,
                      const Tensor<dtypeS, Layout<ShapeS, StrideS>> &src) MMA_IN
            {
                TiledCallFunc::call_copy<Ops<COPY_32x1_F64_RM2CM>, dtypeD, dtypeS>(
                    dst.getPtr(), src.getPtr(), M_32 * AtomShapeM, N_1 * AtomShapeN);
            }
        };
        ...
        private:
            ...
            void call(Tensor<dtypeD, Layout<ShapeD, StrideD>> &dst,
                      const Tensor<dtypeS, Layout<ShapeS, StrideS>> &src) MMA_IN
            {
                TiledCallFunc::call_copy<Ops<COPY_1x16_F64_CM2RM>, dtypeD, dtypeS>(
                    dst.getPtr(), src.getPtr(), M_1 * AtomShapeM, N_16 * AtomShapeN);
            }
        };
        ...
        private:
            ...
            void call(Tensor<dtypeD, Layout<ShapeD, StrideD>> &dst,
                      const Tensor<dtypeS, Layout<ShapeS, StrideS>> &src) MMA_IN
            {
                TiledCallFunc::call_copy<Ops<COPY_16x2_BF16_RM2ZZ>, dtypeD, dtypeS>(
                    dst.getPtr(), src.getPtr(), M_16 * AtomShapeM, N_2 * AtomShapeN);
            }
        };
        ...
        private:
            ...
            void call(Tensor<dtypeD, Layout<ShapeD, StrideD>> &dst,
                      const Tensor<dtypeS, Layout<ShapeS, StrideS>> &src) MMA_IN
            {
                TiledCallFunc::call_copy<Ops<COPY_2x64_BF16_CM2NN>, dtypeD, dtypeS>(
                    dst.getPtr(), src.getPtr(), M_2 * AtomShapeM, N_64 * AtomShapeN);
            }
        };
        ...
        private:
            ...
            void call(Tensor<dtypeD, Layout<ShapeD, StrideD>> &dst,
                      const Tensor<dtypeS, Layout<ShapeS, StrideS>> &src) MMA_IN
            {
                TiledCallFunc::call_copy<Ops<COPY_16x1_BF16_RM2CM>, dtypeD, dtypeS>(
                    dst.getPtr(), src.getPtr(), M_16 * AtomShapeM, N_1 * AtomShapeN);
            }
        };
        ...
        private:
            ...
            void call(Tensor<dtypeD, Layout<ShapeD, StrideD>> &dst,
                      const Tensor<dtypeS, Layout<ShapeS, StrideS>> &src) MMA_IN
            {
                TiledCallFunc::call_copy<Ops<COPY_1x64_BF16_CM2RM>, dtypeD, dtypeS>(
                    dst.getPtr(), src.getPtr(), M_1 * AtomShapeM, N_64 * AtomShapeN);
            }
        };
        ...
        private:
            ...
            void call(Tensor<dtypeD, Layout<ShapeD, StrideD>> &dst,
                      const Tensor<dtypeS, Layout<ShapeS, StrideS>> &src) MMA_IN
            {
                TiledCallFunc::call_copy<Ops<COPY_16x4_INT8_RM2ZZ>, dtypeD, dtypeS>(
                    dst.getPtr(), src.getPtr(), M_16 * AtomShapeM, N_4 * AtomShapeN);
            }
        };
        ...
        private:
            ...
            void call(Tensor<dtypeD, Layout<ShapeD, StrideD>> &dst,
                      const Tensor<dtypeS, Layout<ShapeS, StrideS>> &src) MMA_IN
            {
                TiledCallFunc::call_copy<Ops<COPY_4x64_INT8_CM2NN>, dtypeD, dtypeS>(
                    dst.getPtr(), src.getPtr(), M_4 * AtomShapeM, N_64 * AtomShapeN);
            }
        };
        ...
        private:
            ...
            void call(Tensor<dtypeD, Layout<ShapeD, StrideD>> &dst,
                      const Tensor<dtypeS, Layout<ShapeS, StrideS>> &src) MMA_IN
            {
                TiledCallFunc::call_copy<Ops<COPY_32x4_INT8_RM2ZZ>, dtypeD, dtypeS>(
                    dst.getPtr(), src.getPtr(), M_32 * AtomShapeM, N_4 * AtomShapeN);
            }
        };
        ...
        private:
            ...
            void call(Tensor<dtypeD, Layout<ShapeD, StrideD>> &dst,
                      const Tensor<dtypeS, Layout<ShapeS, StrideS>> &src) MMA_IN
            {
                TiledCallFunc::call_copy<Ops<COPY_4x32_INT8_CM2NN>, dtypeD, dtypeS>(
                    dst.getPtr(), src.getPtr(), M_4 * AtomShapeM, N_32 * AtomShapeN);
            }
        };

        static inline __attribute__((always_inline))
        void kupl_prefetch_L1(const void *data)
        {
        ...
        static inline __attribute__((always_inline))
        void kupl_prefetch_L2(const void *data)
        {
            __asm__ __volatile__(
                "prfm PLDL2KEEP, [%[data]]         \n\t"
                :: [data] "r" (data));
