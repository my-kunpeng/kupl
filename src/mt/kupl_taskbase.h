...
static kupl_always_inline void kupl_tb_init(kupl_taskbase_t *tb, kupl_tb_param_t *param, int geid)
{
    tb->type = param->type;
    ...
    tb->executor_id = (user_desc->field_mask & KUPL_TB_DESC_FIELD_EXECUTOR_ID) ? user_desc->executor_id :
                                                                                 KUPL_TB_EXECUTOR_ID_DEFAULT;
...
static kupl_always_inline int kupl_tb_test(kupl_taskbase_t *tb)
{
